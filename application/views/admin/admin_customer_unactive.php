...
$(this).toggleClass("current");
	...
	<tr>
		...
		?></td>
		<td><?php echo anchor('admin/Admin_customer/edit_customer/' . $content['customer_id'],'编辑')?>|<?php echo anchor('admin/Admin_customer/delete_unactived_customer/' . $content['customer_id'],'删除')?>|<?php echo anchor('admin/Admin_customer/actived_customer/' . $content['customer_id'],'激活')?></td>
	</tr>
	<?php 
		}
	}
