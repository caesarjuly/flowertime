...
$(this).toggleClass("current");
	...
	<ul class="sorttype">
	<li>输入会员姓名：</li>
	<form name = "form1" action = "search_course_message" method = "post" onsubmit = "return check()">
	...
	<?php if(isset($contents) && count($contents))
		...
		?>
		<td><?php echo "未回复"?>
		<td><?php echo anchor('admin/Admin_message/reply_course_message_view/' . $content['message_id'],'回复')?>|<?php echo anchor('admin/Admin_message/delete_course_message/' . $content['message_id'],'删除')?></td>
		<?php
		}
		else 
		{
