<?php $this->load->view('admin/include/active_nav.php'); ?>
    ...
    <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
        <tr>
      <td class="left_title_1">您可以在下面编辑新的套系：</td>
      <td>&nbsp;</td>
    <tr>
      <td class="left_title_2">套系内容：</td>
      <td>
      <?php echo form_open('admin/Admin_series/edit_series/' . $contents['series_id']);?>
               <p> 套系名：<input type="text" class="txt" name='name' value = "<?php echo $contents['name']?>"/></p>
               <p> 价&nbsp;&nbsp;&nbsp;格：<input type="text" class="txt" name='price' value="<?php echo $contents['price']?>"/></p>
               <p> 标签颜色:<input  name="table_danyuan"  type="text" onfocus="colordialog()"  value="<?php echo $contents['color']?>"></p>
	 中文介绍： <textarea id="content2" name="content2"  style="visibility:hidden; "><?php echo $contents['content']?></textarea>
	 英文介绍： <textarea id="content3" name="content3"  style="visibility:hidden;"><?php echo $contents['english_content']?></textarea>
