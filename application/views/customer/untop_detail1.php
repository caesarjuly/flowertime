...
<body onload="alert1()">
	...
	<div id="message">
		...
		<?php echo form_open('customer/Customer_activity/create_untop_activity_message/' . $images['activity_id'])?>
		<textarea  name="untop_activity_message" rows="10" cols="100"></textarea><?php echo form_error('untop_activity_message')?>
		<p>
			<span >
			<input type="hidden" name="untop_activity_message_hidden" value="untop_activity_message_hidden"/>
		...
		<div id="message_box">
			...
			?><div class="message_content">
				<p style="color:#ed1b24;"><?php echo $content['name']?>：     <?php echo $content['content']?></p>
				<p align="right" style= "font-size: 14px;color: #0099CC"><?php echo date('Y年m月d日  H:i:s ',$content['date'])?></p>
				<p>
