...
<head>
    ...
    $(window).load(function() {
      ...
      <script>
		...
		function alert1(){
			$.messager.alert('提示信息：','课堂留言成功，等待管理员审核!');
		}
	</script>
</head>
<body onload="alert1()">
	...
	<div id="top">
		<p id="top_title"><?php echo $cont['title']?></p>
	</div>
	<div id="main">
	<div id="content">
		<div id="detail">
	...
	<div id="message">
		...
		<?php echo form_open('customer/Customer_course/create_message/' . $cont['course_id'])?>
		<textarea  name="message" rows="10" cols="100"></textarea><?php echo form_error('message')?>
		<p>
			<span >
		...
		<div id="message_box">
			...
			<?php 
				foreach ($conte as $message)
				{		
			?><div class="message_content">
				<p style="color:#ed1b24;"><?php echo $message['name']?>：     <?php echo $message['content']?></p>
				<p align="right" style= "font-size: 14px;color: #0099CC"><?php echo date('Y年m月d日  H:i:s ',$message['date'])?></p>
				<p>
					【花·时间儿童摄影】：<?php echo $message['reply'];?>
				</p>
				<p align="right" style= "font-size: 14px;color: #0099CC"><?php echo date('Y年m月d日  H:i:s ',$message['reply_date'])?></p>
				<br>
				<p></p>
			<div class="clear"></div>
			</div>
